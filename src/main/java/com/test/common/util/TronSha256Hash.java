...
public class TronSha256Hash implements Serializable, Comparable<TronSha256Hash> {
    ...
    private byte[] generateBlockId(long blockNum, TronSha256Hash blockHash) {
    ...
    public TronSha256Hash(long num, byte[] hash) {
    ...
    public TronSha256Hash(long num, TronSha256Hash hash) {
        byte[] rawHashBytes = this.generateBlockId(num, hash);
        checkArgument(rawHashBytes.length == LENGTH);
        this.bytes = rawHashBytes;
        this.blockNum = num;
     ...
     */
    @Deprecated
    public TronSha256Hash(byte[] rawHashBytes) {
        checkArgument(rawHashBytes.length == LENGTH);
        this.bytes = rawHashBytes;
    }
    ...
    public static TronSha256Hash wrap(byte[] rawHashBytes) {
        return new TronSha256Hash(rawHashBytes);
    }

    public static TronSha256Hash wrap(ByteString rawHashByteString) {
     ...
     */
    @Deprecated
    public static TronSha256Hash create(byte[] contents) {
        return of(contents);
    }
     ...
     */
    public static TronSha256Hash of(byte[] contents) {
     ...
     */
    public static TronSha256Hash of(File file) throws IOException {
     ...
     */
    @Deprecated
    public static TronSha256Hash createDouble(byte[] contents) {
     ...
     */
    public static TronSha256Hash twiceOf(byte[] contents) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof TronSha256Hash)) {
            return false;
        }
        return Arrays.equals(bytes, ((TronSha256Hash) o).bytes);
    }

    @Override
    public String toString() {
        return TronByteArray.toHexString(bytes);
    }
    ...
    @Override
    public int compareTo(final TronSha256Hash other) {
